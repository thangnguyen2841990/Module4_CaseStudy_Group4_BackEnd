...
@Repository
public interface IImagePostGroupRepository extends JpaRepository<ImagePostGroup, Long> {
    ...
    @Query(value = "select image from image_post_group where id = ?1",nativeQuery = true)
